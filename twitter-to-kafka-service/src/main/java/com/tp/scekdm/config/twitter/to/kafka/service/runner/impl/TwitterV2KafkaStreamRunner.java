    ...
    public void start() throws TwitterException {
        ...
        if(bearerToken != null){
            try {
                ...
                LOG.error("Error in streaming tweets!", e);
                throw new RuntimeException("Error in streaming tweets!", e);
            }
        } else {
            LOG.error("There was a problem getting your bearer token, Please make sure that you set the " +
                    "TWITTER_BEARER_TOKEN environment variable.");
            throw new RuntimeException("There was a problem getting your bearer token, Please make sure that you set the " +
                    "TWITTER_BEARER_TOKEN environment variable.");
        }
    }
